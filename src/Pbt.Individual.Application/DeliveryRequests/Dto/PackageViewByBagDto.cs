...
namespace Pbt.Individual.Web.ViewModels.DeliveryRequests
{
    public class PackageViewByBagDto : FullAuditedEntityDto<int>
    {
        ...
        public int? LastBagId { get; set; } 
        public string ShippingPartnerName { get; set; }

        public string OrderCode { get; set; }

        public string WaybillCodeFake { get; set; }
        ...
        public int PartnerShippingStatus { get; set; } // Trạng thái vận chuyển của đối tác
        public DateTime? PartnerInChinaTime { get; set; }
        public DateTime? PartnerClosedInChinaTime { get; set; }
        public DateTime? PartnerDeliveryToVietnamTime { get; set; }
        public DateTime? PartnerInVietNamTime { get; set; }
        public DateTime? PartnerDeliveredTime { get; set; }
        public DateTime? ClosedTime { get; set; } // Thời gian kiện được đóng (đóng bao hoặc đóng gỗ)
