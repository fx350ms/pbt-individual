...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = IndividualConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(IndividualDbContext context)
    {
        _context = context;
    }
