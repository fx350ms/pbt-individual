...
using Pbt.Individual.Models.TokenAuth;
...
public abstract class IndividualWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static IndividualWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(IndividualWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<IndividualDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<IndividualDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<IndividualDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<IndividualDbContext, Task<T>> func)
    {
        T result;
